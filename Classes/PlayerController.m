...
- (void)viewDidLoad
{
    ...
    CGRect wb = [[self getKeyWindow] bounds];//App.keyWindow.bounds;
...
{
    /*if (!self.showNotesController) {// DevD To Do
    ...
    controller.episode = [PlaybackManager playbackManager].playingEpisode;
