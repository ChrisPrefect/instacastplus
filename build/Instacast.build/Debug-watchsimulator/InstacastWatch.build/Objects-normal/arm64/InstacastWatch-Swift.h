...
#ifndef INSTACASTWATCH_SWIFT_H
#define INSTACASTWATCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="InstacastWatch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class WCSessionFile;
SWIFT_CLASS("_TtC14InstacastWatch27WatchConnectivityController")
@interface WatchConnectivityController : NSObject <WCSessionDelegate>
...
SWIFT_CLASS("_TtC14InstacastWatch20WatchDownloadManager")
@interface WatchDownloadManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface WatchDownloadManager (SWIFT_EXTENSION(InstacastWatch)) <NSURLSessionDownloadDelegate>
...
@class AVAudioPlayer;
SWIFT_CLASS("_TtC14InstacastWatch21WatchPlayerController")
@interface WatchPlayerController : NSObject <AVAudioPlayerDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
