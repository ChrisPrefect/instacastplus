...
deletion = method_body(MANAGER, "private func applyRemoteDeletion")
...
pending_episodes = method_body(MANAGER, "private func applyPendingEpisodeStates")
...
pending_subscriptions = method_body(MANAGER, "private func applyPendingSubscriptions")
